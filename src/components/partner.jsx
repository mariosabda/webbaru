...
const Partner = () => {
    return (
        <div className="w-full py-10 text-black bg-white" id="partner">
            ...
            and she helps me stay motivated in working on this project. <a href="https://bit.ly/timmysspecialday" className="text-[#FF204E] hover:text-[#800000] hover:underline font-semibold">And now is her special day</a>
            </p>
            <p className="text-lg mx-auto px-10 py-10 italic">
            ...
            He is a top student at <a href="https://www.itb.ac.id/" className="text-[#FF204E] hover:text-[#800000] hover:underline font-bold">STEI ITB</a> and has received many awards both nationally and internationally.
            </p>
        </div>
    )
}
